...
class Section(Document):
    ...
    startTime = DateTimeField(db_field='start_time', min_value=datetime(1, 1, 1, 8, 0, 0),
                              max_value=datetime(1, 1, 1, 19, 30, 0), required=True)
    ...
    def __init__(self, course: Course, sectionNumber: int, semester: str, sectionYear: int, building: str, room: int, schedule: str, startTime: datetime, instructor: str, *args, **values):
